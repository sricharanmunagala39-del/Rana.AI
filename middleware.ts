...
const PUBLIC_PATHS = ["/login", "/signup", "/forgot-password", "/reset-password", "/api/auth/login", "/api/auth/signup", "/api/auth/2fa", "/api/auth/forgot", "/api/auth/reset", "/api/webhooks", "/api/cron", "/landing", "/legal", "/blog", "/robots.txt", "/sitemap.xml", "/opengraph-image", "/api/sarvam/diagnose"];
