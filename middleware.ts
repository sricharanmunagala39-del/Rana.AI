...
const PUBLIC_PATHS = ["/login", "/signup", "/api/auth/login", "/api/auth/signup", "/api/auth/2fa", "/api/webhooks", "/api/cron", "/landing", "/legal", "/robots.txt", "/sitemap.xml", "/opengraph-image", "/api/sarvam/diagnose"];
