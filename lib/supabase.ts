...
export type Client = { id: string; name: string; industry: Industry; company_name: string | null; sarvam_app_id: string | null; login_email: string; login_password: string; is_active: boolean; created_at: string; webhook_secret: string; };
export type Script = { id: string; client_id: string; name: string; greeting: string; instructions: string; facts: string[]; speaker: string; speech_rate: number; speech_pitch: number; starting_language: string; background_sound: string; status: "draft" | "active"; published_at: string | null; created_at: string; updated_at: string; };
