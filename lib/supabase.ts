...
export type Client = { id: string; name: string; industry: Industry; company_name: string | null; sarvam_app_id: string | null; login_email: string; login_password: string; is_active: boolean; created_at: string; };
