...
const LINES: Record<string, string | { f: string; m: string }> = {
  ...
  // Everyday spoken style (common English words kept, as callers really talk) — short, so the preview starts fast.
  te: "హలో సార్! నేను RANA నుంచి {name}ని. మీరు అడిగిన కొత్త బ్యాచ్ గురించి కాల్ చేశాను. రెండు నిమిషాలు మాట్లాడొచ్చా?",
  hi: {
    f: "हेलो सर! मैं RANA से {name} बोल रही हूँ। आपने नए बैच के बारे में पूछा था — दो मिनट बात कर सकते हैं?",
    m: "हेलो सर! मैं RANA से {name} बोल रहा हूँ। आपने नए बैच के बारे में पूछा था — दो मिनट बात कर सकते हैं?",
  },
  ta: "ஹலோ சார்! நான் RANA-ல இருந்து {name} பேசுறேன். நீங்க கேட்ட புது பேட்ச் பத்தி கால் பண்ணேன். ரெண்டு நிமிஷம் பேசலாமா?",
  kn: "ಹಲೋ ಸಾರ್! ನಾನು RANA ಇಂದ {name} ಮಾತಾಡ್ತಿದೀನಿ. ನೀವು ಕೇಳಿದ ಹೊಸ ಬ್ಯಾಚ್ ಬಗ್ಗೆ ಕಾಲ್ ಮಾಡಿದೆ. ಎರಡು ನಿಮಿಷ ಮಾತಾಡ್ಬಹುದಾ?",
  ...
  or: "ନମସ୍କାର! ମୁଁ RANA ରୁ {name} କହୁଛି। ଆପଣ ପଚାରିଥିବା ନୂଆ ବ୍ୟାଚ୍ ବିଷୟରେ ଦୁଇ ମିନିଟ୍ କଥା ହୋଇପାରିବା କି?",
  ur: {
